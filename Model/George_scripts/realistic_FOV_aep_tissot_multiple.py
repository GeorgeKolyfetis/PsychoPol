    ...
    try:
        ...
        with open(coordinates_file, 'r') as file:
            for line in file:
                ...
                if elevation_deg == 90: # this is for the unlikely case of 90deg elevation. Normally a limit has to be calculated, but no need for this is a good enough approximation (in pixel size)
                    elevation_deg = 89.9
